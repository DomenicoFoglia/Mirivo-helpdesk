...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore inserito per :attribute è apparso in una violazione di dati. Scegline uno diverso.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Qui puoi tradurre i nomi dei campi che appaiono nei messaggi.
    | Esempio: 'email' => 'indirizzo email' fara' apparire "L'indirizzo email
    | e' obbligatorio" invece di "L'email e' obbligatorio".
    */
